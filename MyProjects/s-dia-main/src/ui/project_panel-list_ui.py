...
################################################################################
## Form generated from reading UI file 'project_panel-list.ui'
##
...
"")
        ...
        self.desc_container.setGeometry(QRect(0, 0, 208, 129))
        ...
        self.show_info_button = QPushButton(self.project_section)
        self.show_info_button.setObjectName(u"show_info_button")

        self.project_name_layout.addWidget(self.show_info_button)
        ...
        self.listWidget = QListWidget(self.data_section)
        self.listWidget.setObjectName(u"listWidget")

        self.data_layout.addWidget(self.listWidget)

        self.data_list_widget = QScrollArea(self.data_section)
        self.data_list_widget.setObjectName(u"data_list_widget")
        self.data_list_widget.setFrameShape(QFrame.Shape.NoFrame)
        self.data_list_widget.setFrameShadow(QFrame.Shadow.Plain)
        self.data_list_widget.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.data_list_widget.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.data_list_widget.setWidgetResizable(True)
        self.data_list_container = QFrame()
        self.data_list_container.setObjectName(u"data_list_container")
        self.data_list_container.setGeometry(QRect(0, 0, 210, 122))
        ...
        self.data_list_widget.setWidget(self.data_list_container)

        self.data_layout.addWidget(self.data_list_widget)
        ...
        self.flow_list_container.setGeometry(QRect(0, 0, 210, 122))
        ...
        self.menu_layout.addItem(self.verticalSpacer_3)
    ...
    def retranslateUi(self, ProjectMenuPanel):
        ...
        self.show_info_button.setText(QCoreApplication.translate("ProjectMenuPanel", u"PushButton", None))
