...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        if not ui_file_found:
            ...
            MessageDialog.critical(self, "오류", "UI 파일을 찾을 수 없습니다.")
            sys.exit(1)
        ...
        try:
            ...
            try:
                ...
                if user_info['user_id'] == login_id and user_info['password'] == password:
                    ...
                    MessageDialog.warning(self, '로그인 오류', '아이디 또는 비밀번호가 일치하지 않습니다.')
            ...
            self.logger.error("상세 오류:", exc_info=True)
            MessageDialog.critical(self, '오류', '로그인 처리 중 오류가 발생했습니다.')
